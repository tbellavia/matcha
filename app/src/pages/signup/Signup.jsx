        ...
        <Page>
            <Background paddingTop={2} title="inscription">
                <Form label="valider" onSubmit={onSubmitHandler}>
                    <Input label="mail" type="email" value={email.value} onChange={emailChange} />
                    <Input label="mot de passe" type="password" value={password.value} onChange={passwordChange} />
                    <Input label="confirmation" type="password" value={validationPassword.value} onChange={validationPasswordChange} />
                </Form>
            </Background>
        </Page>
    );
