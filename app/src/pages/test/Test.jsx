...
function Test() {
    ...
    return (
        <GenericPage className={styles.test} style={style}>
            <FeedProfile chatProfile={{"photo":photo, "name":"hello","iduser":9}} notification={true}/>
        </GenericPage>
    );
}
